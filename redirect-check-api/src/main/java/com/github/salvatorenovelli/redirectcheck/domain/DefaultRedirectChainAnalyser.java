 ...
 * {@link RedirectChain}
 */
public class DefaultRedirectChainAnalyser implements RedirectChainAnalyser {


    private static final Logger logger = LoggerFactory.getLogger(DefaultRedirectChainAnalyser.class);
    private final HttpRequestFactory requestFactory;

    public DefaultRedirectChainAnalyser(HttpRequestFactory requestFactory) {
